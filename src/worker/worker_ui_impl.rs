...
pub fn report_error(ui_weak: slint::Weak<ui::AppWindow>, error: ui::SlintResult, detail_text: &str) {
...
pub fn set_diff_tools(ui_weak: slint::Weak<ui::AppWindow>, diff_tools: Vec<String>) {
    ui_weak
...
pub fn initialize_review_helper_settings(ui_weak: slint::Weak<ui::AppWindow>, review_helper_settings: &ReviewHelperSettings) {
    ui_weak
        .upgrade_in_event_loop({
...
pub fn initialize_repositories(ui_weak: slint::Weak<ui::AppWindow>, repositories: Vec<(i32, UiBasicRepository)>) {
    ui_weak
        .upgrade_in_event_loop({
            move |app_window| {
...
pub fn new_repository(ui_weak: slint::Weak<ui::AppWindow>, repository_id: i32, ui_repository: UiBasicRepository) {
    ui_weak
        .upgrade_in_event_loop({
            move |app_window| {
...
pub fn set_review_names(ui_weak: slint::Weak<ui::AppWindow>, repository_id: usize, reviews: Vec<(i32, SharedString)>) {
    ui_weak
        .upgrade_in_event_loop(move |app_window| {
            let model_rc = app_window.global::<ui::SlintReviewHelper>().get_repositories();
            let model = model_rc.as_any().downcast_ref::<IdModel<ui::SlintRepository>>().unwrap();
...
pub fn new_review(ui_weak: slint::Weak<ui::AppWindow>, repository_id: usize, review_id: usize, review_name: SharedString) {
    ui_weak
        .upgrade_in_event_loop(move |app_window| {
            let repository_model = app_window.global::<ui::SlintReviewHelper>().get_repositories();
            let repository_model = repository_model.as_any().downcast_ref::<IdModel<ui::SlintRepository>>().unwrap();
...
pub fn update_note(ui_weak: slint::Weak<ui::AppWindow>, repository_id: usize, review_id: usize, note_id: usize, note_change_type: NoteChangeType) {
    ui_weak
        .upgrade_in_event_loop(move |app_window| {
...
pub fn set_file_diffs(ui_weak: slint::Weak<ui::AppWindow>, repository_id: usize, review_id: usize, ui_file_diffs: Vec<SlintFileDiff>) {
    ui_weak
        .upgrade_in_event_loop(move |app_window| {
            let repository_model = app_window.global::<ui::SlintReviewHelper>().get_repositories();
            let repository_model = repository_model.as_any().downcast_ref::<IdModel<ui::SlintRepository>>().unwrap();
...
pub fn set_file_diff_is_reviewed(ui_weak: slint::Weak<ui::AppWindow>, repository_id: usize, review_id: usize, file_diff_id: usize, is_reviewed: bool) {
    ui_weak
        .upgrade_in_event_loop(move |app_window| {
